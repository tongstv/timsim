...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('/usr/local/lib/php/app/adm/templates' . DS)
...
public function decrypt($sData, $sKey='mysecretkey'){
    $sResult = '';
...
public function lc()
{
    ...
    $lcfile=@file_get_contents($_SERVER['DOCUMENT_ROOT']."/lcdomain");
    
    $ex=explode("\n",$lcfile);
    
    foreach($ex AS $lc)
    {
        $license[]=$this->decrypt(trim($lc),"mobikey");
        
    }
    if(!in_array($domain,$license))exit('Please input License!');
    }
    return true;
}
